...
class Detail extends Component {
    ...
    componentDidMount() {
        let { year, month, day, category, file } = this.props.match.params;
        fetch(`https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=${global.api}&q=${year + "/" + month + "/" + day + "/" + category + "/" + file}`)
            .then(res => res.json())
            .then(
                (result) => {
                    this.setState({
    ...
    render() {
        ...
        const { year, month, day, category, file } = this.props.match.params;
                    ...
                    <div className={classes.rootContent}>
                        <Grid container justify={"center"} spacing={2}>
                            ...
                            {items && items.map(item => {
                                ...
                                if (item.web_url == "https://www.nytimes.com/" + year + "/" + month + "/" + day + "/" + category + "/" + file) {
                                    return (
